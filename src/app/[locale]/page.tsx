...
import { HeroEntrance, HeroBg } from "@/components/ui/HeroEntrance";
  ...
  return (
    <div className="flex flex-col flex-grow">
      ...
      <section className="relative overflow-hidden h-[calc(100vh-80px)] border-b border-outline-variant bg-black flex flex-col justify-center">
        ...
        <HeroEntrance>
          <Badge variant="secondary" className="mb-stack-sm tracking-widest text-primary bg-primary-fixed border border-primary-fixed-dim py-1 px-4">
            {siteConfig.established[locale]}
          </Badge>
          
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-white mb-stack-lg max-w-5xl mx-auto leading-none font-black tracking-tight drop-shadow-2xl">
            {t.heroTitle}
          </h1>
          
          <p className="font-sans text-sm md:text-xl text-white/90 max-w-3xl mx-auto mb-stack-lg leading-relaxed drop-shadow">
            {t.heroSubtitle}
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center items-center gap-stack-md pt-6">
            <Link
              href={`/${locale}/volunteer`}
              className="bg-primary text-on-primary font-sans text-label-md px-10 py-4.5 rounded-full hover:opacity-95 transition-all duration-300 shadow-xl w-full sm:w-auto text-center hover:scale-105 bg-gradient-animate tracking-wide focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none"
            >
              {t.becomeMember}
            </Link>
            <Link
              href={`/${locale}/about`}
              className="border border-white/40 text-white bg-white/10 backdrop-blur-sm font-sans text-label-md px-10 py-4.5 rounded-full hover:bg-white/20 transition-all duration-300 w-full sm:w-auto text-center hover:scale-105 tracking-wide focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none"
            >
              {t.learnMore}
            </Link>
          </div>
      ...
      <section className="py-section-gap max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <Reveal>
          <div className="grid md:grid-cols-2 gap-margin-desktop items-center">
            <div className="relative aspect-square w-full rounded-xl overflow-hidden border border-outline-variant shadow-heritage group hover:border-primary/50 transition-colors duration-500">
              <Image
            ...
            <div className="space-y-stack-md">
              ...
              <div className="pt-2">
                <Link
                  href={`/${locale}/about`}
                  className="text-primary font-sans text-label-md font-bold inline-flex items-center gap-1 hover:underline transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded"
                >
      ...
      {/* 4. Immersive Legacy of Ward 21 Section */}
      <section className="bg-surface-container-low py-section-gap border-y border-outline-variant">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop space-y-stack-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter pt-6">
            <Reveal delay={0}>
              <Card hoverEffect={false} className="card-hover-lift bg-surface-bright p-stack-lg flex flex-col justify-between h-[300px] border border-outline-variant/60 shadow-heritage rounded-xl">
                <div className="space-y-stack-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
          {detailedPillars.map((pillar, idx) => (
            <Reveal key={pillar.id} delay={idx * 0.08}>
              <Card className="card-hover-lift flex flex-col justify-between p-stack-lg bg-surface-container-low h-[430px] border border-outline-variant/60 shadow-heritage rounded-xl">
                <div className="space-y-stack-md">
                ...
                <Link
                  ...
                  className="text-secondary font-sans text-xs font-bold inline-flex items-center gap-1 hover:text-primary transition-colors mt-6 pt-3 border-t border-outline-variant/60 focus-visible:ring-2 focus-visible:ring-secondary focus-visible:outline-none rounded"
                >
                  {t.viewDetails}
                  <span className="material-symbols-outlined text-sm">arrow_forward</span>
                </Link>
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <Reveal>
            <div className="grid md:grid-cols-2 gap-margin-desktop items-center">
              ...
              <div className="relative aspect-video rounded-xl overflow-hidden border border-outline-variant shadow-heritage group">
                <Image
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAygFvbbqJB_fa_V2A_Fl4SHw-rgNMKLfLbmE00LGYCSdmiLxCTlgJeRjOiwygNqC-SAnxoQkzmW4p6O_hNoG-p9kygr5if7-fLVGMAaPxFFsXyEJyVe4PsdtK48G0Op-6vREhdjhOLZmFT-Fz9lX9-sVpDR4lug3Cn_CcNEBxPPPPDetQLhMhaFj2QV2KUbKqoEN1Dc-eA6iWA8Ih4EDgOwtybSpjJgs1ImdKFVbA_b1GmeclbIqNm97AI3aoF84yNuBPW01Z5kOE"
      ...
      {/* 7. Official President's Welcome Segment */}
      <section className="py-section-gap max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <Reveal>
      ...
      <section className="py-section-gap bg-surface-container-low border-t border-b border-outline-variant">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop space-y-stack-lg">
          <Reveal>
            <h2 className="font-serif text-3xl md:text-4xl text-primary font-bold text-center">
          ...
          <div className="grid md:grid-cols-2 gap-gutter">
            {testimonials.map((test, idx) => (
              <Reveal key={idx} delay={idx * 0.08}>
                <Card hoverEffect={false} className="card-hover-lift bg-surface-bright flex flex-col justify-between py-6 px-8 border-l-4 border-primary shadow-sm border border-outline-variant/40 rounded-xl h-full">
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid md:grid-cols-2 gap-margin-desktop">
          ...
          <div className="space-y-stack-lg animate-fade-in-up">
            <div className="flex justify-between items-end border-b border-outline-variant pb-2">
              ...
              <Link href={`/${locale}/events`} className="font-sans text-xs text-secondary hover:text-primary font-semibold focus-visible:ring-2 focus-visible:ring-secondary focus-visible:outline-none rounded">
                {t.viewAllEvents}
              </Link>
            </div>
            ...
            <div className="space-y-stack-md">
              {upcomingEvents.map((event, idx) => (
                <Reveal key={event.id} delay={idx * 0.08}>
                  <div className="flex gap-4 p-4 rounded-xl bg-surface border border-outline-variant/60 shadow-heritage hover:border-secondary/60 transition-colors duration-300">
          ...
          <div className="space-y-stack-lg animate-fade-in-up">
            <div className="flex justify-between items-end border-b border-outline-variant pb-2">
              ...
              <Link href={`/${locale}/news`} className="font-sans text-xs text-primary hover:opacity-80 font-semibold focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded">
                {t.viewAllNews}
              </Link>
            </div>
            ...
            <div className="space-y-stack-md">
              {latestNews.map((news, idx) => (
                <Reveal key={news.id} delay={idx * 0.08}>
                  <div className="grid grid-cols-3 gap-4 items-center">
                    <div className="relative aspect-video rounded-lg border border-outline-variant overflow-hidden">
                      <Image
                        src={news.image}
                    ...
                    <div className="col-span-2 space-y-1">
                      ...
                      <h4 className="font-serif text-title-lg text-primary font-semibold line-clamp-1 hover:underline">
                        <Link href={`/${locale}/news#${news.id}`} className="focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded">
                          {news.title[locale]}
                        </Link>
                      </h4>
      ...
      <section className="py-section-gap max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop text-center space-y-4">
        <Reveal>
          ...
          <Link
            href={`/${locale}/volunteer`}
            className="bg-primary text-on-primary font-sans text-label-md px-10 py-4.5 rounded-full hover:opacity-95 transition-all duration-300 shadow-xl inline-block hover:scale-105 bg-gradient-animate tracking-wide focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none"
          >
            {t.joinUs}
          </Link>
        </Reveal>
